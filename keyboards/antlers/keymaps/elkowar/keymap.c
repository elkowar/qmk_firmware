...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [_MOUSE] = LAYOUT(
        ...
        _______,     _______,  _______,  DRAG_SCRL,SNIPE,     _______,                           KC_BTN2,  DRAG_SCRL,_______,  _______,  _______,  _______, \
        _______,     _______,  _______,  _______,  _______,   KC_BTN3,                           KC_BTN3,  _______,  _______,  _______,  _______,  _______, \
                                         _______,  _______,   KC_BTN2, KC_BTN1,        KC_BTN2,  _______,  _______,  _______ \
    )
